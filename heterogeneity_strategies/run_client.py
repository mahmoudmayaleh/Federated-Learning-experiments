...
from client import CustomClient, ScaffoldClient
from utils import load_client_data


DATA_ROOT = Path(__file__).resolve().parent
DEFAULT_DATA_DIR = DATA_ROOT.parent / "baseline_federated_training" / "distributed_data"
...
def main():
    ...
    client = ScaffoldClient(model, train_loader, test_loader, device)
